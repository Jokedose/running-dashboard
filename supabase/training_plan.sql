...
insert into public.training_plan (
  ...
  ('2026-06-04', '2026-W23', 'วิ่งเบาฟื้นตัว + ยืดเหยียด', 'วิ่งเบา', 4.00, 42, 630, 'Z2 เบา', 'รองเท้าซ้อมประจำวัน', 'normal', 'planned', 'คุมหัวใจให้นิ่ง แล้วปิดท้ายด้วย mobility 8 นาที'),
  ('2026-06-05', '2026-W23', 'พัก / เดินเบา', 'ฟื้นตัว', null, 30, null, 'เบามาก', null, 'low', 'planned', 'เดินได้ถ้าขายังสด ไม่ต้องฝืนซ้อม'),
  ('2026-06-06', '2026-W23', 'วิ่งยาว Z2', 'วิ่งยาว', 8.00, 84, 630, 'Z2', 'รองเท้าซ้อมประจำวัน', 'high', 'planned', 'ซ้อมหลักของสัปดาห์ เป้า drift ไม่เกิน 5 bpm ไม่ไล่เพซ'),
  ('2026-06-08', '2026-W24', 'วิ่งเบา + strides', 'วิ่งเบา', 5.00, 50, 600, 'Z2 + strides', 'รองเท้าเบา', 'normal', 'planned', 'ปิดท้ายด้วย strides ผ่อนคลาย 4 x 20 วินาที'),
  ...
  ('2026-06-14', '2026-W24', 'วิ่งยาวไล่ระดับ', 'วิ่งยาว', 9.00, 92, 615, 'Z2 นิ่ง', 'รองเท้าซ้อมประจำวัน', 'high', 'planned', 'ถ้า drift ยังนิ่ง ค่อยเพิ่มความเร็ว 10 นาทีท้าย'),
